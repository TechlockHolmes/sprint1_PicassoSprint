...
function draw() {
  ...
  //Liz has changed the ellipses into squares
  //The positions of the shapes are now shifted to different places
  square(100, 100, diameter0*1000, diameter0*1000);
  ellipseMode(RADIUS);
  fill(0,255,0);
  square(200, 50, diameter1, diameter1);
  ellipseMode(RADIUS);
  fill(0,0,255);
  square(1000, 50, diameter2, diameter2);
