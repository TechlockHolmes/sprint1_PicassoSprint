...
function draw() {
  ...
  //I centered all the circles together and changed their colours 
  //to make a cool looking target shape
  ellipse(950, 500, diameter0*200, diameter0*200);
  ellipseMode(RADIUS);
  fill(255,255,0);
  ellipse(950, 500, diameter1, diameter1);
  ellipseMode(RADIUS);
  fill(255,0,0);
  ellipse(950, 500, diameter2, diameter2);
