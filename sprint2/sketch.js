...
function draw() {
  ...
  ellipseMode(RADIUS);
  //I filled all the circles to be fully white and increased the stroke around the circles
  fill(255,255,255);
  stroke(0, 0, 40, 1200);
  //console.log("diameter0  "  + diameter0);
  //Liz duplicated each one of the potentiometer circles three times
  //then spaced them out to become a series of circles that can increase
  //in size.
  ellipse(200, 100, diameter1, diameter1);
  ellipseMode(RADIUS);
  fill(255,255,255);
  ellipse(900, 100, diameter1, diameter1);
  ellipseMode(RADIUS);
  fill(255,255,255);
  ellipse(1600, 100, diameter1, diameter1);
  ellipseMode(RADIUS);


  var freq = map(diameter0, 1, width, 40, 880);
    osc1.freq(freq);
    //console.log(freq);

  var freq2 = map(diameter1, 1, width, 40, 880);
    osc2.freq(freq2);
    //console.log(freq2);

 var freq3 = map(diameter2, 1, width, 40, 880);
    osc3.freq(freq3);
    //console.log(freq3);
}
